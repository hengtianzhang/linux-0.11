/*
 * 标准符号常数和类型头文件。
 * 定义了__LIBRARY__则还将包括内核系统调用号和内嵌汇编_syscall()
 */
#ifndef _UNISTD_H
#define _UNISTD_H
...
#define STDOUT_FILENO 1 //输出
#define STDERR_FILENO 2 //出错
...
#define R_OK 4 //检测是否可写

/*lseek文件指针重定位*/
/*定义符号常数用于lseek()和fcntl()函数*/
